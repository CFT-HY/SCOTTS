...
This is non unique and can be modified. We follow the update outlined in Anninos
and Fragile 2002.

-# Store lorentz factor at start of step [evolve_hydro_storeWold()]

-# Temperature, pressure and \f$\kappa\f$ calculated [eq_of_state()]
-# Calculate velocities and Lorentz factor \f$ W \f$ [evolve_hydro_velocities()]
...
-# Calculate velocities and Lorentz factor \f$ W \f$ [evolve_hydro_velocities()]
-# Temperature, pressure and \f$\kappa\f$ calculated [eq_of_state()]
-# Update \f$ E \f$ with PdV work terms. (Not including dW/dt
terms). [evolve_hydro_pressurework()]
